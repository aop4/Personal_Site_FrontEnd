export default {
  'translation': {
    ...
    'photos.flickr.intro': 'Mira más fotos mías en ',
    'contact': {
      'title': 'Contáctame',
      'hints': {
        'name': ' Su nombre',
    ...
    'music': {
      'title': 'Álbumes',
      'intro': 'Escribo y grabo canciones para divertirme. Si le gustan éstas, es posible que disfrute de escuchar a <a href="https://bloomcliffe.bandcamp.com">Bloomcliffe</a>.'
    },
    'language.toggle': {
      'hover.text': 'Cambiar de lengua',
      'title': 'English'
    }
  }
}