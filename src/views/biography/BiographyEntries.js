...
export const BIOGRAPHY_ENTRIES = [
    ...
    new BiographyEntry('2014', 'fa-brain', '#039be5',
    ...
    new BiographyEntry('2015', 'fa-microscope', '#6a1b9a',
    ...
    new BiographyEntry('2016', 'fa-code-branch', '#039be5',
        [
    ...
    new BiographyEntry('2016', 'fa-rocket', '#ad1457',
        [
    ...
    new BiographyEntry('2017', 'fa-code', '#37474f',
        [
    ...
    new BiographyEntry('2018', 'fa-mobile-alt', '#4e342e',
        [
    ...
    new BiographyEntry('2019', 'fa-mortar-pestle', '#283593',
        [
    ...
    new BiographyEntry('Tomorrow', 'fa-map', '#ad1457',
        [
