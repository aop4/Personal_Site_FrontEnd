    ...
    render() {
        return (
            <div className="software-container text-container">
                ...
                <p>I am also interested in human-computer interaction and the broader effects of technology on society. I am interested in how to use technology to make the world a better place. That's a difficult task because of the place technology often takes in the world, and I do not view tech as a panacea. To make a positive difference, technology must meet with the right people and the right intentions.</p>
