    ...
    render() {
        return (
            <div className="software-container text-container">
                ...
                <p>During interviews, I've often asked people why unit tests are important. The usual answer is this: unit tests run quickly, and manual tests have to be slowly and painstakingly repeated. That's correct. But the candidates don't go any further.</p>
                <p>Unit tests vet code in a way no manual test possibly could. They examine each function, each individual component of the system. If your code were a bicycle, this would be like separately testing every piece that goes into the bicycle. The spokes, the chain, the handbrakes, the cables, the shocks. When we test all these individual components, we have that much more confidence in the bicycle itself.</p>
                <p>And what if we never tested them? What if the handbrake designer never tried squeezing the brake and the chain was never spun on a chainring? The parts might come off the assembly line with imperceptible defects, and I certainly wouldn't want to touch your bike. Unit tests ensure the stability of the system by testing it deeply. And of course, if someone breaks some code down the road, automated tests serve as a quality gate.</p>
                <p>Another benefit of unit testing is that it encourages you to dream up all the edge cases your code might encounter and to consider if it's designed in such a way that future programmers can easily use it.</p>
                ...
                <p>No one wants to deal with a 400-line function. No one even wants to scroll through it. On the other hand, we don't usually sit down and say, "I want to write a 400-line function today." So how does it happen?</p>
                <p>One way to ensure your functions are concise—and that they <em>stay</em> concise—is to ensure that they do just one thing. retrieveInventoryItems() should retrieve some items from an inventory, for example. But it shouldn't also send an email, update those items in a database, and store the speed of light in a global variable.</p>
                ...
                <p>Blasphemy, I know. You want speed, strict typing, and elegant object-oriented language features when you're building something at scale. I like to point out that Instagram was built with Python, which meets none of those criteria. And Instagram is pretty big.</p>
                ...
                <p>I don't mean to say every tool will meet your needs equally; I mean to say you should consider them more or less interchangeable with their peers, though. Think &#123; React, Angular, Vue, JQuery &#125;; &#123; Node, Django, Spring, Ruby on Rails &#125;; &#123; C#, Java, TypeScript, C++ &#125;. The members within each set are capable of doing pretty much the same things–they just use different approaches.</p>
                <p>A good developer is always capable of learning a new language or framework. Specific languages and frameworks should be a relatively small part of project and hiring decisions.</p>
                ...
                <p>Beginner programmers get frustrated easily. This is natural: it's difficult to deal with a machine that can only interpret instructions literally. Computers are completely unforgiving and provide cryptic feedback.</p>
                ...
                <p>A new developer might have a good idea. A quality assurance analyst might have a good idea. A product owner might have a good idea. Even if you have more experience under your belt, listen to them. Certainly don't make your mind up before they have the opportunity to defend their thoughts. There is value in a fresh perspective.</p>
                <p>Conversely, don't hesitate to question someone with more experience than you. It's a great way to learn. And if you get into the weeds and see that their design has some holes in it, they'll be grateful when you point it out.</p>
                ...
                <p>If software is good, someone somewhere is going to ask you to make it better. Sometimes it happens in the middle of the development process, and sometimes it happens after a release. In a truly agile process, we give the customer time and space to provide feedback, we listen, and we iterate on our design and implementation to satisfy their needs.</p>
